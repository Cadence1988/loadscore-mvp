...
Evaluate freight with your truck costs, deadhead, profit targets, and destination context.

## Full description

LoadScore helps truck drivers and owner-operators evaluate freight opportunities using their own operating numbers.

Use the popup to review:

- all-in rate per mile, including deadhead;
- estimated operating profit;
- loaded and empty miles;
- a starter Reload Score for destination context;
...
LoadScore helps truck drivers and owner-operators evaluate user-provided freight opportunities using their operating costs, deadhead, profitability targets, destination context, and saved preferences.

## Category recommendation

Productivity. Founder must select the final category in the developer dashboard.

## Support and website

- Website: https://loadscore-mvp.vercel.app
- Support contact used by the current app: rgm88@loadscore.app

Founder must verify control of the support address before submission.
