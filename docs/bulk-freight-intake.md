...
Supported normalized fields include route, rate, loaded miles, deadhead, pickup/delivery timing, equipment, weight, stops, broker/reference, load ID, expiration, and source provenance. Missing deadhead remains unknown rather than becoming confirmed zero. A provisional estimate may be shown for correction, but it cannot receive a mode match, notification, comparison save, or Top 7 rank until deadhead is added or zero is explicitly confirmed.
